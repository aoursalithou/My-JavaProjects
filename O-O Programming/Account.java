...
import ch15.BankApp.Exception.InsufficientBalanceException;
import ch15.BankApp.Exception.NegativeAmountException;
import ch15.BankApp.Exception.SsnNotValidException;

import java.time.LocalDateTime;

public abstract class Account extends IdentifiableEntity {
    private String iban;
    private User holder;
    ...
    protected abstract boolean isSSnValid(String ssn);
}